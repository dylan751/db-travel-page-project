...
import classes from './RecommendedDestination.module.css';
    ...
    <section className={classes['recommended-destination']}>
      <div className={classes['recommended-destination-container']}>
        ...
        <ul className={classes['destination']}>
          <li>
            <img
              src="/images/destination/toronto.jpg"
              alt="Australia"
              loading="lazy"
            />
          ...
          <li>
            <img
              src="/images/destination/istanbul.jpg"
              alt="Newzealand"
              loading="lazy"
            />
            <div className={classes['description']}>
          ...
          <li>
            <img
              src="/images/destination/pho-co.jpg"
              alt="Egypt"
              loading="lazy"
            />
            <div className={classes['description']}>
          ...
          <li>
            <img
              src="/images/destination/mount-fuji.jpg"
              alt="Africa"
              loading="lazy"
            />
            <div className={classes['description']}>
